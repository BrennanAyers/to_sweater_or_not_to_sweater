class Currently
  attr_reader :summary, :icon, :precip_probability, :precip_type, :temperature, :apparent_temperature, :humidity, :uvIndex, :visibility, :temperature_high, :temperature_low
  ...
  def initialize(full_forecast, daily_forecast)
    ...
    @uv_index_number = full_forecast[:uvIndex]
